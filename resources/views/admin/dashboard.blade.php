    ...
    <div class="_container">
        <div class="headings flex_align">
            ...
            <button class="cta card flex_align">
                ...
                <a style="text-decoration: none" href="{{ route('admin.products.create') }}">
                    <p>Add Product</p>
                </a>
            </button>
        </div>
        ...
        <div class="data_grid">
            <div class="card flex_align">
                ...
                <div class="chart_detail">
                    <h1 class="totalEarning" data-totalBuyAmount="{{ $totalBuyAmount }}"
                        data-totalPaid="{{ $totalPaid }}" style="color: rgb(104, 142, 255)">
                        ${{ $totalPaid }}
                    </h1>
            ...
            <div class="card flex_align">
                ...
                <div class="chart_detail">
                    <h1 class="totalUser" data-totalUser="{{ $totalUser }}" data-userHasOrder="{{ $userHasOrder }}">
                        {{ $totalUser }}
                    </h1>
